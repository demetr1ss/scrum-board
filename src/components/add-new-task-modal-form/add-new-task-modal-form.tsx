...
type AddNewTaskModalFormPropsType = {
  isAddNewTaskModalOpened: boolean;
  setIsAddNewTaskModalOpened: (status: boolean) => void;
};

export default function AddNewTaskModalForm({isAddNewTaskModalOpened: isModalOpened, setIsAddNewTaskModalOpened: setIsModalOpened}: AddNewTaskModalFormPropsType) {
