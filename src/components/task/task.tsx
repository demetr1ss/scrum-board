...
export default function Task({
  ...
  const onChangeStatusButtonClick = () => {
    setCurrentTask(task);
    setIsChangeStatusModalOpened(true);
  };
    ...
    <Draggable draggableId={id} index={index}>
      {(provided: DraggableProvided, snapshot: DraggableStateSnapshot) => (
        <li
          ...
          tabIndex={0}
        >
          <div className={`${styles[fieldName as keyof typeof styles]} ${styles.wrapper}`}>
            ...
            <div className={styles.tools} hidden={!isToolsVisible}>
              ...
              >
                <svg xmlns='http://www.w3.org/2000/svg' xmlSpace='preserve' width='20' height='20' viewBox='0 0 64 64'>
                  <path d='m-576 0H704v800H-576z' fill='none' />
                  <path d='m14.563 17.167 7.468-7.468 2.61 2.61-10.107 10.107-6.359-6.358 2.64-2.64 3.748 3.749Zm41.456.806H28.026v-3.969h27.993v3.969Z' />
                  <path d='m14.563 17.167 7.468-7.468 2.61 2.61-10.107 10.107-6.359-6.358 2.64-2.64 3.748 3.749Zm41.456.806H28.026v-3.969h27.993v3.969ZM14.563 49.167l7.468-7.468 2.61 2.61-10.107 10.107-6.359-6.358 2.64-2.64 3.748 3.749Zm41.456.806H28.026v-3.969h27.993v3.969Z' />
                  <path d='m14.563 49.167 7.468-7.468 2.61 2.61-10.107 10.107-6.359-6.358 2.64-2.64 3.748 3.749Zm41.456.806H28.026v-3.969h27.993v3.969ZM14.563 33.167l7.468-7.468 2.61 2.61-10.107 10.107-6.359-6.358 2.64-2.64 3.748 3.749Zm41.456.806H28.026v-3.969h27.993v3.969Z' />
                  <path d='m14.563 33.167 7.468-7.468 2.61 2.61-10.107 10.107-6.359-6.358 2.64-2.64 3.748 3.749Zm41.456.806H28.026v-3.969h27.993v3.969Z' />
                </svg>
              </button>
              <button
              ...
              >
                <svg xmlns='http://www.w3.org/2000/svg' xmlSpace='preserve' width='20' height='20' viewBox='0 0 128 128'>
              ...
              <button
                ...
                onBlur={() => setIsToolsVisible(false)}
              >
                <svg xmlns='http://www.w3.org/2000/svg' xmlSpace='preserve' width='20' height='20' viewBox='0 0 40 40'>
